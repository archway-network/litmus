...
//module github.com/archway-network/litmus
...
require (
	...
	//github.com/archway-network/archway v9.0.0-rc1
	github.com/archway-network/archway v1.0.1
...
require (
	...
	github.com/cosmos/ibc-apps/modules/ibc-hooks/v8 v8.0.0-20240820215527-05462618a4e8 // indirect
...
replace cosmossdk.io/api => cosmossdk.io/api v0.7.5
...
replace github.com/archway-network/voter => ../archway/contracts/go/voter
...
replace golang.org/x/exp => golang.org/x/exp v0.0.0-20240404231335-c0f41cb1a7a0
